...
## should convert angular-2.pug to output matching angular-2.html
...
## should convert angular.pug to output matching angular.html
...
## should convert apostrophe.pug to output matching apostrophe.html
...
## should convert attr-multiline.pug to output matching attr-multiline.html
...
## should convert code-inline.pug to output matching code-inline.html
...
## should convert code-multiline.pug to output matching code-multiline.html
...
## should convert comment.pug to output matching comment.html
...
## should convert conditional.pug to output matching conditional.html
...
## should convert conditional2.pug to output matching conditional2.html
...
## should convert conditional3.pug to output matching conditional3.html
...
## should convert empty-class.pug to output matching empty-class.html
...
## should convert entity.pug to output matching entity.html
...
## should convert headless.pug to output matching headless.html
...
## should convert html5boilerplate.pug to output matching html5boilerplate.html
...
## should convert leading_equal.pug to output matching leading_equal.html
...
## should convert mustache.pug to output matching mustache.html
...
## should convert only-body.pug to output matching only-body.html
...
## should convert only-head.pug to output matching only-head.html
...
## should convert pfft.pug to output matching pfft.html
...
## should convert pre1.pug to output matching pre1.html
...
## should convert pre2.pug to output matching pre2.html
...
## should convert pre3.pug to output matching pre3.html
...
## should convert test.pug to output matching test.html
...
## should convert textarea-javascript.pug to output matching textarea-javascript.html
...
## should convert whitespace.pug to output matching whitespace.html
...
## should convert whitespace2.pug to output matching whitespace2.html
...
## should convert without-comma.pug to output matching without-comma.html
...
## should convert angular-2.html to match snapshot
...
## should convert angular.html to match snapshot
...
## should convert apostrophe.html to match snapshot
...
## should convert attr-multiline.html to match snapshot
...
## should convert code-inline.html to match snapshot
...
## should convert code-multiline.html to match snapshot
...
## should convert comment.html to match snapshot
...
## should convert conditional.html to match snapshot
...
## should convert conditional2.html to match snapshot
...
## should convert conditional3.html to match snapshot
...
## should convert empty-class.html to match snapshot
...
## should convert entity.html to match snapshot
...
## should convert headless.html to match snapshot
...
## should convert html5boilerplate.html to match snapshot
...
## should convert leading_equal.html to match snapshot
...
## should convert mustache.html to match snapshot
...
## should convert only-body.html to match snapshot
...
## should convert only-head.html to match snapshot
...
## should convert pfft.html to match snapshot
...
## should convert pre1.html to match snapshot
...
## should convert pre2.html to match snapshot
...
## should convert pre3.html to match snapshot
...
## should convert test.html to match snapshot
...
## should convert textarea-javascript.html to match snapshot
...
## should convert whitespace.html to match snapshot
...
## should convert whitespace2.html to match snapshot
...
## should convert without-comma.html to match snapshot
...
## should convert without-html.html to match snapshot
...
## should convert bodyless.html to match snapshot
...
## should convert bodyless2.html to match snapshot
...
## should convert parse-style.html to match snapshot
